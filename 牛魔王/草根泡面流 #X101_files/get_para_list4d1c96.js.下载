...
function o(){
return A?void(T.showTailPanel&&T.showTailPanel()):void t();
}
function a(){
...
return e.err_msg.indexOf("fail")>-1?void g.report115849(40):void(j=!0);
});
}
function s(e){
n({
...
"appear"===e.state&&(T.hasAd?T.showAd&&T.showAd():o());
});
}
function d(e){
function n(){
o=!0,setTimeout(function(){
return a?void(o=!1):(s+=c,(T.canCreateTailWebview||d>=t-s)&&r(),void n());
},1e3*c);
}
function i(){
v.invoke("handleMPPageAction",{
...
if(A){
var n=h.getId("js_video_tail_panel");
n&&(w(e),n.style.display="",h.getId("js_replay").addEventListener("click",function(){
...
var v=e("biz_wap/jsapi/core.js"),f=e("a/a_config.js"),m=e("biz_common/utils/url/parse.js"),g=e("a/a_utils.js"),P=e("biz_wap/utils/mmversion.js"),h=e("pages/utils.js"),b=e("common/comm_report.js"),y=e("biz_common/dom/event.js"),j=!1,T={},A=P.cpVersion("7.0.9",1,!0),D={
