...
var o=Math.random();
.001>o&&document.getElementById("js_read_area3")&&document.getElementById("js_read_area3").innerText&&document.getElementById("js_read_area3").innerText.indexOf("Pageview")>-1&&C.setSum(24729,95,1),
...
var Q,G=null;
R(),h.on(window,"scroll",R),T(),h.on(window,"scroll",O),window.is_new_msg&&-1!=navigator.userAgent.indexOf("MicroMessenger")&&(window.title&&(window.title=window.title.replace(/&#39;/g,"'").replace(/&nbsp;/g," ").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&")),
...
e.offsetTop<n?(t=!0,h.off(window,"scroll",i),C.setSum(59977,15,1),b.hotspotReport({
...
n.offsetTop<s&&(r=!0,C.setSum(59977,15,1));
}
});
}
...
C.setSum(28307,18,1),_.isIOS&&C.setSum(28307,19,1),_.isAndroid&&C.setSum(28307,20,1);
},!1);
}(),function(){
...
e("appmsg/popup_report.js")),E=e("appmsg/pay_report_utils.js"),z=e("appmsg/loading.js"),P=-1,S=e("appmsg/finance_communicate.js"),B=e("appmsg/topbar.js"),C=e("biz_wap/utils/jsmonitor_report.js"),R=e("appmsg/getForbidConfig.js");
window.new_appmsg&&(e("page/appmsg_new/combo.css"),e("page/appmsg_new/not_in_mm.css")),
e("appmsg/finance_communicate.js");
var T=window.user_uin||0,O=Math.floor(T/100)%1e3,q=0!==T&&1001>O,N=!0,D="",L=5;
