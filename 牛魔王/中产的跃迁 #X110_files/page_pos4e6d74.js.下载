...
"undefined"!=typeof voiceid&&c&&voiceid&&c===voiceid&&!function(){
var e=o.offsetTop+122-40;
setTimeout(function(){
window.scrollTo(0,e);
},0);
}(),e++);
...
var o=location.href.indexOf("scrolltodown")>-1,t=T.js_cmt_area;
if(o&&t&&t.offsetTop){
var i=t.offsetTop;
!e.disableScroll&&window.scrollTo(0,i-25);
}else"undefined"!=typeof voiceid&&voiceid||(!e.disableScroll&&window.scrollTo(0,N),
f.saveSpeeds({
uin:uin,
pid:"https:"==x?462:417,
speeds:{
...
function i(e){
for(var o=0,t=R.length;t>o;++o)if(R[o]==e)return!0;
return!1;
}
function n(){
...
var e=[];
for(var o in O)O.hasOwnProperty(o)&&(window.networkType&&"wifi"==window.networkType&&!E&&i(o)&&(E=!0),
e.push(o));
return O={},e.join(",");
}
function a(){
