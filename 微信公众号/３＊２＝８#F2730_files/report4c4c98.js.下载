...
var e=arguments.length<=0||void 0===arguments[0]?[]:arguments[0],t=0,a=0,i=[],o=[];
for(var n in e){
var _=e[n],p=_.pos_type===AD_POS.POS_MID,r=_.pos_type===AD_POS.POS_AD_BEFORE_VIDEO,d=_.pos_type===AD_POS.POS_BOTTOM;
p&&t++,d&&a++,p||r&&0===_.is_mp_video||d||_.pos_type===AD_POS.POS_AD_AFTER_VIDEO||r&&1===_.is_mp_video||_.pos_type===AD_POS.POS_SPONSOR?o.push(_):i.push(_);
}
if(a>1){
for(var s=[],l={
aid:Date.now(),
pos_type:AD_POS.POS_BOTTOM
},n=o.length-1;n>=0;n--)o[n].pos_type===AD_POS.POS_BOTTOM&&s.push(o.splice(n,1)[0]);
l.children=s.reverse(),l.flow_exp_info=l.children[0].flow_exp_info,o.push(l);
}
return{
oldAdInfos:i,
newAdInfos:o,
