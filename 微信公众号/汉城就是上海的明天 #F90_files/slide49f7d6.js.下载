...
});define("new_video/player.js",["page/pages/video.css","biz_common/utils/string/html.js","biz_wap/zepto/zepto.js","biz_wap/zepto/event.js","biz_wap/zepto/touch.js","biz_wap/jsapi/log.js","biz_common/dom/event.js","new_video/player.html.js","biz_wap/utils/device.js","new_video/ctl.js","biz_common/tmpl.js","pages/iframe_communicate.js","a/a_utils.js","biz_common/utils/url/parse.js","pages/version4video.js","biz_wap/utils/wapsdk.js","biz_common/base64.js","biz_wap/jsapi/core.js","new_video/plugin/util.js","common/utils.js"],function(e){
"use strict";
function t(){
o(),i();
}
...
try{
parent.window.__MpBindExitFullPage||(parent.window.__MpBindExitFullPage=!0,S.listenMpPageAction(function(e){
...
var o=P.visibilityPausePlayer;
o&&o.hasBeginPlay()&&!o.isEnd()&&(o.play4outer(),P.visibilityPausePlayer=null);
}
}
...
},F=navigator.userAgent,k=function(){
return!0;
}(),M=(-1!==F.indexOf("Safari")&&-1!==F.indexOf("Version")&&-1==F.indexOf("Android"),
function(){
return!!_.browser.M1;
}()),x=function(e,t){
...
},I=!_.canSupportVideo,E=function(e){
...
.1>=n&&(o.needToFit=!0,x("objectFit","fill")&&(o.supportObjectFit=!0,e.videoFit=!0));
}
...
if(r.setAttribute("origin_src",l),I)return s.find(".js_btn_play").attr("href",l).show(),
...
if(t&&t>0&&this.container.find(".js_video_length").html(D(t)).show(),1==this.__iosPreloadPause){
var i=this;
setTimeout(function(){
...
e.log.duration=e.duration,e.duration=e.duration>>0,o.find(".js_total_time").text(D(e.duration)),
...
B("player inner isend:"+t.isEnd()),t.isEnd()&&t.videoEnd();
...
return t.__forcePause===!0||t._g.iosPreloadTmpPlay?void B(t.id+":play playing __forcePause return"):(t.changeStatus({
status:"play",
subStatus:e.type
}),setTimeout(function(){
...
t._g.iosPreloadTmpPlay||(B(t.id+":video pause event"),t.changeStatus({
status:"pause",
subStatus:""
}),setTimeout(function(){
...
function e(){
if(I)return location.href=i.opt.src,!1;
i.changeStatus({
status:"loading",
subStatus:"preload"
});
...
var v,w,y,T,S=0,b=0,P=0,j=i.__getDuration(),C=0,B=0,F=1,M=window.user_uin||0,x=0!==M&&Math.floor(M/100)%1e3<F,D=!1,E=0,N=!0,V=!1,L=null;
h.on("touchstart",function(e){
1==e.targetTouches.length&&i.isPlay()&&(o.blockTouchVideo||(L&&(clearTimeout(L),
L=null),y=v=new Date,T=w={
x:e.targetTouches[0].clientX,
y:e.targetTouches[0].clientY
},i._g.touchForwarding=!1,V=!0,N=!0,B=C=i.getCurTime()));
}),h.on("touchmove",function(e){
if(N&&1==e.targetTouches.length&&i.isPlay()&&!o.blockTouchVideo){
var t=new Date,n=e.changedTouches[0].clientX,a=e.changedTouches[0].clientY,s=Math.abs(n-T.x),r=Math.abs(a-T.y);
if(V&&(r>=10||r>s))return N=!1,void(V=!1);
L&&(clearTimeout(L),L=null),V=!1,i._g.touchForwarding=!0;
var l=t-v,d=n-w.x,u=a-w.y,_=Math.sqrt(Math.pow(d,2)+Math.pow(u,2))+P,h=Math.min(Math.ceil(_/l),6);
b=Math.floor(.1*_+.2*h*h*h)*Math.ceil(j/500),P=0==b?_:0,0>d&&(b=-b);
var c=180*Math.atan2(u,d)/Math.PI;
i._g.touchForwarding||(c>=-30&&30>=c&&++S,(c>=150&&180>=c||c>=-180&&-150>=c)&&--S,
(S>=4||-4>=S)&&(5>=_?S=0:(E=Math.max(E,h),i._g.touchForwarding=!0))),i._g.touchForwarding&&(C+=b,
0>C&&(C=0),C>j&&(C=1*j),i.__setForwardBar(C),e.preventDefault()),w={
x:n,
y:a
},v=t;
}
...
i.play(C);
},0),x&&((new Image).src="/mp/jsmonitor?idkey=28307_29_1",!D)){
var t=(new Date,{
...
(new Image).src="/mp/jsmonitor?idkey=28307_31_1;28307_33_"+a+";28307_34_"+E,D=!0;
}
...
i.hideTouchForward(),b=0,V=!1,i._g.touchForwarding=!1,N=!0,S=0;
}),h.on("touchmove MSPointerMove pointermove mousemove",function(e){
i.isInFullScreen()&&!k&&e.preventDefault();
...
i.enterFullScreen()),e.preventDefault(),!1;
});
},
...
this.container.find(".js_now_play_time").text(D(e));
},
...
t.find(".js_forward").removeClass("none"),t.find(".total_time").text(D(i)),t.find(".js_forward_bar").css("width",100*o+"%"),
t.find(".js_forward_play_time").text(D(e));
},
...
this._jsapiLog(a),B(a),p.broadcastMessage({
type:"statusChange",
data:{
id:this.id,
preStatus:o,
